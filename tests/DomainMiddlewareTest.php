...
class DomainMiddlewareTest extends TestCase
{
    ...
    public function testMarketingDomainAllowedWithoutMainDomain(): void {
        $middleware = new DomainMiddleware($this->createProvider(['marketing-domain.tld']));
        $factory = new ServerRequestFactory();
        $request = $factory->createServerRequest('GET', 'https://marketing-domain.tld/');
    ...
    public function testDomainNamespaceResolvesFromDatabase(): void
    {
        ...
        $service->createDomain('admin.promo.example.com', namespace: 'promo');
