...
return function (\Slim\App $app) {
    ...
    $app->get('/admin', AdminController::class)->add(new RoleAuthMiddleware('admin'));
    $app->get('/admin/kataloge', AdminCatalogController::class)->add(new RoleAuthMiddleware('admin'));
    $app->get('/results', [$resultController, 'page'])->add(new RoleAuthMiddleware('admin'));
    $app->get('/results.json', [$resultController, 'get'])->add(new RoleAuthMiddleware('admin'));
    $app->get('/question-results.json', [$resultController, 'getQuestions'])->add(new RoleAuthMiddleware('admin'));
    $app->get('/results/download', [$resultController, 'download'])->add(new RoleAuthMiddleware('admin'));
    $app->get('/results.pdf', [$resultController, 'pdf'])->add(new RoleAuthMiddleware('admin'));
    $app->post('/results', [$resultController, 'post']);
    $app->delete('/results', [$resultController, 'delete'])->add(new RoleAuthMiddleware('admin'));
    $app->get('/config.json', [$configController, 'get']);
    $app->post('/config.json', [$configController, 'post'])->add(new RoleAuthMiddleware('admin'));
    $app->get('/kataloge/{file}', [$catalogController, 'get'])->add(new RoleAuthMiddleware('admin'));
    $app->post('/kataloge/{file}', [$catalogController, 'post'])->add(new RoleAuthMiddleware('admin'));
    $app->delete('/kataloge/{file}/{index}', [$catalogController, 'deleteQuestion'])->add(new RoleAuthMiddleware('admin'));
    $app->put('/kataloge/{file}', [$catalogController, 'create'])->add(new RoleAuthMiddleware('admin'));
    $app->delete('/kataloge/{file}', [$catalogController, 'delete'])->add(new RoleAuthMiddleware('admin'));

    $app->get('/events.json', [$eventController, 'get'])->add(new RoleAuthMiddleware('admin'));
    $app->post('/events.json', [$eventController, 'post'])->add(new RoleAuthMiddleware('admin'));

    $app->get('/teams.json', [$teamController, 'get']);
    $app->post('/teams.json', [$teamController, 'post'])->add(new RoleAuthMiddleware('admin'));
    $app->get('/users.json', [$userController, 'get'])->add(new RoleAuthMiddleware('admin'));
    $app->post('/users.json', [$userController, 'post'])->add(new RoleAuthMiddleware('admin'));
    $app->post('/password', [$passwordController, 'post'])->add(new RoleAuthMiddleware('admin'));
