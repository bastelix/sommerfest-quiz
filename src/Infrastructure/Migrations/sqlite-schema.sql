...
-- 20300113: add stripe_secret_key, stripe_publishable_key to namespace_projects
...
-- Namespace Projects: billing/quota organisation unit
...
VALUES (
    ...
    '<!-- Calhelp marketing content omitted in SQLite schema -->'
);
