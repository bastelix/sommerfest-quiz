...
{
  "headline": {
    "de": "Bausteine – vom Start bis zur gelebten Routine",
    "en": "Building blocks – from kick-off to everyday routine"
  },
  "subheadline": {
    "de": "Sechs Bausteine bringen Ordnung in Daten, Abläufe und Nachweise.",
    "en": "Six building blocks bring clarity to data, workflows and evidence."
  },
  "modules": [
    {
      "id": "start",
      ...
      "pitch": {
        "de": "Wir setzen den Rahmen und holen alle Beteiligten in wenigen Tagen an einen Tisch.",
        "en": "We set the frame and bring every stakeholder together within days."
      },
      "deliverables": {
        "de": [
          "Scope klären & Prioritäten festhalten",
          "Beteiligte abholen & Rollen benennen",
          "Einen machbaren Fahrplan dokumentieren"
        ],
        "en": [
          "Clarify scope and priorities",
          "Align stakeholders and outline roles",
          "Document a feasible starter roadmap"
        ]
      },
      "kpi": {
        "de": "Startklar in Tagen statt Monaten",
        "en": "Ready in days, not months"
      },
      "link": {
        "url": "https://calhelp.notion.site/Trust-Center",
        "label": {
          "de": "Mehr Details im Trust-Center",
          "en": "More details in the trust centre"
        },
        "target": "_blank",
        "rel": "noopener"
      }
    },
    {
      ...
      "pitch": {
        "de": "Wir führen alte und neue Informationen sauber zusammen – ohne Excel-Schleifen.",
        "en": "We merge legacy and new information cleanly – without Excel loops."
      },
      "deliverables": {
        "de": [
          "Dubletten raus, Felder erklärt",
          "Verständliche Regeln für Pflichtangaben",
          "Pilotbereich zum gemeinsamen Test"
        ],
        "en": [
          "Remove duplicates and clarify fields",
          "Easy-to-follow rules for required data",
          "Pilot scope everyone can test together"
        ]
      },
      "kpi": {
        "de": "Ein Datenstand für alle",
        "en": "One shared data baseline"
      },
      "link": {
        "url": "https://calhelp.notion.site/Trust-Center",
        "label": {
    ...
    },
    {
      ...
      "pitch": {
        "de": "Wir zeigen, wer wann dran ist – Freigaben werden nachvollziehbar und kurz.",
        "en": "We make responsibilities visible – approvals become clear and swift."
      },
      "deliverables": {
        "de": [
          "Geführte Schritte statt Ping-Pong",
          "Verantwortung und Vertretung sind sichtbar",
          "Checklisten, die jede:r versteht"
        ],
        "en": [
          "Guided steps instead of ping-pong",
          "Responsibilities and deputies stay visible",
          "Checklists everyone can follow"
        ]
      },
      "kpi": {
        "de": "Freigaben in einem klaren Lauf",
        "en": "Approvals in one clear run"
      },
      "link": {
        "url": "https://calhelp.notion.site/Trust-Center",
        "label": {
    ...
    },
    {
      ...
      "pitch": {
        "de": "Wir binden das an, was schon da ist – Meldungen landen automatisch am richtigen Ort.",
        "en": "We connect what already exists – updates land where they belong automatically."
      },
      "deliverables": {
        "de": [
          "Erprobte Anbindungen für ERP & MET/TEAM",
          "Single Sign-on ohne Umwege",
          "Benachrichtigungen statt Nachfragen"
        ],
        "en": [
          "Tried-and-tested hooks for ERP and MET/TEAM",
          "Single sign-on without detours",
          "Notifications instead of chasing updates"
        ]
      },
      "kpi": {
        "de": "Informationen landen automatisch",
        "en": "Information flows automatically"
      },
      "link": {
        "url": "https://calhelp.notion.site/Trust-Center",
        "label": {
    ...
    },
    {
      ...
      "pitch": {
        "de": "Wir machen Nachweise so zugänglich, dass Prüfungen ohne Extra-Runden durchlaufen.",
        "en": "We make evidence accessible so audits pass without extra loops."
      },
      "deliverables": {
        "de": [
          "Status und Historie jederzeit abrufbar",
          "Vorlagen & Kommentare bleiben verknüpft",
          "Export, der auf Anhieb überzeugt"
        ],
        "en": [
          "Status and history at your fingertips",
          "Templates and comments stay linked",
          "Exports that convince at first glance"
        ]
      },
      "kpi": {
        "de": "Audit-Ordner in einem Tag",
        "en": "Audit pack in a single day"
      },
      "link": {
        "url": "https://calhelp.notion.site/Trust-Center",
        "label": {
    ...
    },
    {
      ...
      "pitch": {
        "de": "Wir sorgen dafür, dass das Wissen bleibt – Teams arbeiten sicher weiter.",
        "en": "We make sure the knowledge sticks – teams keep working with confidence."
      },
      "deliverables": {
        "de": [
          "Trainings & Sprechstunden mit kurzer Lernkurve",
          "Hypercare für offene Fragen",
          "Regelmäßige Reviews statt Feuerlöschen"
        ],
        "en": [
          "Training and coaching with a short learning curve",
          "Hypercare for open questions",
          "Regular reviews instead of fire fighting"
        ]
      },
      "kpi": {
        "de": "Routine statt Strohfeuer",
        "en": "Sustainable routine instead of one-off wins"
      },
      "link": {
        "url": "https://calhelp.notion.site/Trust-Center",
        "label": {
