...
<!-- Live-Dashboard -->
<section id="live-dashboard" class="uk-section section section--plain live-dashboard">
  <div class="uk-container container-xl">
    <div class="uk-grid-large uk-child-width-1-2@m uk-flex-middle" uk-grid>
      <div class="live-dashboard__content">
        <span class="qr-badge">Live-Dashboard</span>
        <h2 class="uk-heading-medium uk-margin-small-top">Alles live im Blick – ohne Regie-Stress</h2>
        <p class="uk-text-lead uk-margin-small-top">
          Verfolgen Sie jedes Team in Echtzeit, reagieren Sie bei Engpässen und feiern Sie Highlights sofort.
          Das Live-Dashboard liefert Ihnen alle Kennzahlen für einen reibungslosen Ablauf.
        </p>
        <ul class="uk-list uk-list-bullet uk-margin-medium-top">
          <li>Live-Rankings, gelöste Stationen und Foto-Uploads auf einen Blick</li>
          <li>Hinweise verschicken, Teams priorisieren und Moderationen vorbereiten</li>
          <li>Exportierbare Reports für Nachbereitung, Sponsoren und Social Media</li>
        </ul>
        <div class="uk-margin-medium-top uk-flex uk-flex-wrap" style="gap: 12px;">
          <a class="uk-button uk-button-primary uk-button-large" href="https://quizrace.app/event/98e5abe1-f80a-4241-8d03-a154ae2f6cb0/dashboard/kqVk1ZTLLBoKdxw0VDwFrcV9" target="_blank" rel="noopener">
            Dashboard live testen
          </a>
          <a class="uk-button uk-button-default uk-button-large" href="#contact-us">
            Beratung anfordern
          </a>
        </div>
      </div>
      <div>
        <div class="uk-card uk-card-quizrace uk-card-body live-dashboard__card" aria-label="Vorschau auf das Live-Dashboard">
          <h3 class="uk-h5 uk-margin-remove">Live-Überblick</h3>
          <p class="uk-text-meta uk-margin-small-bottom">Aktualisiert jede Sekunde</p>
          <ul class="live-dashboard__stats uk-list">
            <li>
              <span class="live-dashboard__stat-label">Teams aktiv</span>
              <span class="live-dashboard__stat-value">8</span>
            </li>
            <li>
              <span class="live-dashboard__stat-label">Abgeschlossene Stationen</span>
              <span class="live-dashboard__stat-value">124</span>
            </li>
            <li>
              <span class="live-dashboard__stat-label">Foto-Missionen</span>
              <span class="live-dashboard__stat-value">27</span>
            </li>
          </ul>
          <div class="live-dashboard__teams">
            <div class="live-dashboard__team">
              <span class="live-dashboard__team-rank">1</span>
              <div class="live-dashboard__team-body">
                <span class="live-dashboard__team-name">Team Blitz</span>
                <span class="live-dashboard__team-score">1.240 Punkte</span>
              </div>
            </div>
            <div class="live-dashboard__team">
              <span class="live-dashboard__team-rank">2</span>
              <div class="live-dashboard__team-body">
                <span class="live-dashboard__team-name">Rätselkönige</span>
                <span class="live-dashboard__team-score">1.180 Punkte</span>
              </div>
            </div>
            <div class="live-dashboard__team live-dashboard__team--highlight">
              <span class="live-dashboard__team-rank">3</span>
              <div class="live-dashboard__team-body">
                <span class="live-dashboard__team-name">City Runner</span>
                <span class="live-dashboard__team-score">1.155 Punkte</span>
              </div>
              <span class="live-dashboard__badge">Foto-Mission abgeschlossen</span>
            </div>
          </div>
        </div>
      </div>
...
<section id="how-it-works" class="uk-section section section--alt">
  <div class="uk-container container-xl">
    ...
    <div class="uk-grid-large uk-child-width-1-3@m uk-grid-match uk-margin-large-top" uk-grid>
      <div>
        <div class="uk-card uk-card-quizrace uk-card-body">
          <h3 class="uk-h5 uk-margin-remove-top">Schritt 1 – Die Idee entsteht 🌱</h3>
          <p class="uk-margin-small-top">„Es soll etwas Besonderes werden – aber noch fehlt die zündende Idee?“<br>Wir pflanzen den ersten Gedanken:</p>
          <ul class="uk-list uk-margin-top uk-text-small">
            <li>Schatzsuche oder Stadtrallye – wie eine Entdeckungstour, bei der jede Station ein neues Rätsel enthüllt</li>
            <li>Escape-Quiz – wie ein Abenteuer, bei dem Codes geknackt und Geheimnisse gelüftet werden</li>
            <li>Team-Challenge – wie ein Wettkampf, bei dem Gruppen gegeneinander antreten und Punkte sammeln</li>
          </ul>
          <p class="uk-margin-small-top">👉 Aus diesem Funken wächst Ihr persönliches Event.</p>
        </div>
      </div>

      <div>
        <div class="uk-card uk-card-quizrace uk-card-body">
          <h3 class="uk-h5 uk-margin-remove-top">Schritt 2 – Der Startschuss 🚀</h3>
          <p class="uk-margin-small-top">„Die Teams sind gespannt – jetzt beginnt das Spiel.“<br>So einfach geht’s:</p>
          <ul class="uk-list uk-margin-top uk-text-small">
            <li>QR-Aufkleber platzieren – wie kleine Hinweise, die an Türen, Wänden oder Objekten warten</li>
            <li>Ein Scan genügt – wie ein Schlüssel, der sofort die passende Aufgabe öffnet</li>
            <li>Keine App, kein Aufwand – wie ein spontanes Spiel, das überall sofort funktioniert</li>
          </ul>
          <p class="uk-margin-small-top">👉 Mit wenigen Handgriffen ist Ihr Event live.</p>
        </div>
      </div>

      <div>
        <div class="uk-card uk-card-quizrace uk-card-body">
          <h3 class="uk-h5 uk-margin-remove-top">Schritt 3 – Das Finale 🏆</h3>
          <p class="uk-margin-small-top">„Alle fiebern der Auswertung entgegen – die Spannung steigt.“<br>Jetzt zeigt sich, wer vorne liegt:</p>
          <ul class="uk-list uk-margin-top uk-text-small">
            <li>Live-Ranking auf Knopfdruck – wie eine Siegerehrung in Echtzeit</li>
            <li>Urkunden und Reports – wie ein Erinnerungsalbum, sofort erstellt und teilbar</li>
            <li>Applaus &amp; Gänsehaut-Momente – wie ein Abschluss, der lange in Erinnerung bleibt</li>
          </ul>
          <p class="uk-margin-small-top">👉 So endet Ihr Event mit einem Highlight.</p>
        </div>
      </div>
    </div>
    ...
    <div class="uk-text-center uk-margin-large">
      ...
      <a class="uk-button uk-button-default uk-button-large" href="https://quizrace.app/?event=98e5abe1-f80a-4241-8d03-a154ae2f6cb0&amp;katalog=DFB-QUIZ" target="_blank" rel="noopener">Demo ansehen</a>
    </div>
  </div>
</section>
...
<section id="editor" class="uk-section section section--alt">
  <div class="uk-container container-xl">
    <div class="uk-grid-large uk-flex-middle uk-child-width-1-2@m" uk-grid>
      <div>
        <h2 class="uk-heading-medium">Editor im Überblick</h2>
      ...
      <div>
        <div class="editor-showcase" uk-slideshow="animation: fade; ratio: 16:9">
              ...
              <li>
                <div class="uk-card uk-card-quizrace uk-card-body">
                  <picture>
                    ...
                    <img src="{{ basePath }}/uploads/landing/quizrace-shot-backend.webp" width="960" height="540" loading="lazy" alt="Screenshot des QuizRace-Editors mit Aufgabenverwaltung und Drag-and-drop-Steuerung">
                  </picture>
                </div>
              </li>
              <li>
                <div class="uk-card uk-card-quizrace uk-card-body">
                  <picture>
                    ...
                    <img src="{{ basePath }}/uploads/landing/quizrace-shot-frontend.webp" width="960" height="540" loading="lazy" alt="Screenshot des QuizRace-Live-Dashboards mit Ranking und Teamstatus">
                  </picture>
                </div>
              </li>
            </ul>

            <a class="uk-position-center-left uk-position-small uk-hidden-hover" href="#" uk-slidenav-previous aria-label="Vorherige Editor-Ansicht"></a>
            <a class="uk-position-center-right uk-position-small uk-hidden-hover" href="#" uk-slidenav-next aria-label="Nächste Editor-Ansicht"></a>
          </div>
          <ul class="uk-slideshow-nav uk-dotnav uk-flex-center uk-margin-small-top" aria-label="Editor-Ansichten auswählen"></ul>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="uk-container uk-container-small">
    ...
    <ul class="uk-accordion uk-margin-large-top" uk-accordion>
      ...
      <li>
        ...
        <div class="uk-accordion-content">
          <p>Nein, QuizRace läuft im Browser auf jedem Gerät.</p>
        </div>
      </li>
      <li>
      ...
      <li>
        <a class="uk-accordion-title" href="#">Kann man das Abo später ändern?</a>
        <div class="uk-accordion-content">
          <p>Ja, ein Upgrade in ein höheres Paket ist jederzeit möglich – ohne Einschränkungen.<br>Ein Downgrade funktioniert ebenfalls, solange die Anzahl Ihrer aktiven Events zum gewählten Paket passt.</p>
        </div>
      </li>
      <li>
        <a class="uk-accordion-title" href="#">Funktioniert QuizRace auch draußen oder unterwegs?</a>
        <div class="uk-accordion-content">
          <p>Ja, überall dort, wo mobile Daten verfügbar sind. Die QR-Codes lassen sich an Objekten oder Orten anbringen – ideal für Schnitzeljagden, Rallyes und Outdoor-Events.</p>
        </div>
      </li>
      <li>
        <a class="uk-accordion-title" href="#">Wie sicher sind unsere Daten?</a>
        <div class="uk-accordion-content">
          <p>QuizRace läuft DSGVO-konform und wird in Deutschland gehostet.<br>Jede Organisation erhält ihre eigene Instanz (Single-Tenant).<br>Ihre Daten bleiben vollständig unter Ihrer Kontrolle.</p>
        </div>
      </li>
      <li>
        <a class="uk-accordion-title" href="#">Wie viele Teilnehmende können mitmachen?</a>
        <div class="uk-accordion-content">
          <p>Es gibt keine feste Grenze – ob 10 oder 1.000 Personen.<br>Im Starter-Paket gelten kleine Limits, in höheren Abos ist nahezu alles möglich.</p>
        </div>
      </li>
      <li>
        <a class="uk-accordion-title" href="#">Kann ich das Quiz individuell anpassen?</a>
        <div class="uk-accordion-content">
          <p>Ja, Sie können Fragen, Texte und sogar das Branding anpassen.<br>So wird jedes Quiz einzigartig – passend zu Ihrem Event.</p>
        </div>
      </li>
      </ul>
    </div>
