-- Fix block-contract violations in the calserver page content.
-- The initial migration (20260217) inserted blocks that violate the schema:
--   * testimonials: had unexpected "title" and "quotes" fields
--   * pricing: plans were missing the required "id" field
-- This migration replaces the full page content with the corrected version.
