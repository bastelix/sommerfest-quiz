...
VALUES (
    ...
    'calHelp',
    $CALHELP$
<section id="solutions" class="uk-section calhelp-section" data-page-theme="default" aria-labelledby="solutions-title">
  <div class="uk-container">
    ...
    <div class="calserver-stats-strip calhelp-proof-strip" role="list">
      <article class="calserver-stats-strip__item calhelp-proof-card" role="listitem" aria-labelledby="solutions-double-title">
        <p class="calhelp-proof-card__eyebrow">Situation</p>
        <h3 id="solutions-double-title" class="calhelp-proof-card__headline">Doppelte Erfassung.</h3>
        <p class="calhelp-proof-card__subhead">„Excel, E-Mails, Ordner?“</p>
        <p class="calhelp-proof-card__body">Ein Arbeitsstand statt fünf Ablagen.</p>
      </article>
      <article class="calserver-stats-strip__item calhelp-proof-card" role="listitem" aria-labelledby="solutions-audit-title">
        <p class="calhelp-proof-card__eyebrow">Situation</p>
        <h3 id="solutions-audit-title" class="calhelp-proof-card__headline">Audit-Druck.</h3>
        <p class="calhelp-proof-card__subhead">„Nachweise jagen?“</p>
        <p class="calhelp-proof-card__body">Checkliste, Diffs &amp; Historie an einem Ort.</p>
      </article>
      <article class="calserver-stats-strip__item calhelp-proof-card" role="listitem" aria-labelledby="solutions-approval-title">
        <p class="calhelp-proof-card__eyebrow">Situation</p>
        <h3 id="solutions-approval-title" class="calhelp-proof-card__headline">Unklare Freigaben.</h3>
        <p class="calhelp-proof-card__subhead">„Wer gibt was frei?“</p>
        <p class="calhelp-proof-card__body">Geführte Workflows, klare Verantwortung.</p>
      </article>
    </div>
    <div class="uk-margin-large-top">
      <h3 class="uk-heading-bullet">So helfen wir</h3>
      <div class="calserver-stats-strip calhelp-proof-strip" role="list">
        <article class="calserver-stats-strip__item calhelp-proof-card" role="listitem" aria-labelledby="solutions-organise-title">
          <p class="calhelp-proof-card__eyebrow">Hebel</p>
          <h4 id="solutions-organise-title" class="calhelp-proof-card__headline">Ordnen.</h4>
          <p class="calhelp-proof-card__body">Wir schaffen Überblick – Daten &amp; Rollen an einem Ort.</p>
        </article>
        <article class="calserver-stats-strip__item calhelp-proof-card" role="listitem" aria-labelledby="solutions-simplify-title">
          <p class="calhelp-proof-card__eyebrow">Hebel</p>
          <h4 id="solutions-simplify-title" class="calhelp-proof-card__headline">Vereinfachen.</h4>
          <p class="calhelp-proof-card__body">Weg mit Doppelarbeiten, hin zu klaren Wegen.</p>
        </article>
        <article class="calserver-stats-strip__item calhelp-proof-card" role="listitem" aria-labelledby="solutions-prove-title">
          <p class="calhelp-proof-card__eyebrow">Hebel</p>
          <h4 id="solutions-prove-title" class="calhelp-proof-card__headline">Belegen.</h4>
          <p class="calhelp-proof-card__body">Nachweise, die beim ersten Mal bestehen.</p>
        </article>
      </div>
    </div>
  </div>
...
<section id="approach" class="uk-section calhelp-section" data-page-theme="default" aria-labelledby="approach-title">
  <div class="uk-container">
    <div class="calhelp-section__header">
    ...
    <div class="calserver-stats-strip calhelp-proof-strip" role="list">
      <article class="calserver-stats-strip__item calhelp-proof-card" role="listitem" aria-labelledby="approach-understand-title">
        <p class="calhelp-proof-card__eyebrow">Schritt 1</p>
        <h3 id="approach-understand-title" class="calhelp-proof-card__headline">Verstehen.</h3>
        <p class="calhelp-proof-card__body">In 30–45 Minuten klären wir Zielbild, Beteiligte und Stolpersteine.</p>
      </article>
      <article class="calserver-stats-strip__item calhelp-proof-card" role="listitem" aria-labelledby="approach-structure-title">
        <p class="calhelp-proof-card__eyebrow">Schritt 2</p>
        <h3 id="approach-structure-title" class="calhelp-proof-card__headline">Ordnen.</h3>
        <p class="calhelp-proof-card__body">Wir sortieren Daten, Rollen und Verantwortungen – zuerst dort, wo es sofort entlastet.</p>
      </article>
      <article class="calserver-stats-strip__item calhelp-proof-card" role="listitem" aria-labelledby="approach-deliver-title">
        <p class="calhelp-proof-card__eyebrow">Schritt 3</p>
        <h3 id="approach-deliver-title" class="calhelp-proof-card__headline">Umsetzen.</h3>
        <p class="calhelp-proof-card__body">Wir liefern den ersten belastbaren Nachweis und zeigen, wie der Alltag damit leichter läuft.</p>
      </article>
    </div>
...
<section id="process" class="uk-section calhelp-section" data-page-theme="default" aria-labelledby="process-title">
  <div class="uk-container">
    <div class="calhelp-section__header">
    ...
    <div class="calhelp-process-details">
      <div class="calhelp-process-details__header">
        <h3 class="calhelp-process-details__title">Details für Technik &amp; IT</h3>
      </div>
      <div class="calhelp-process" data-page-stepper>
        ...
        <div class="calhelp-process__stages" data-page-slider>
          <div class="calhelp-process__track" data-page-slider-track>
            <article id="process-step-readiness"
                     class="calhelp-process__stage calhelp-process__stage--active calhelp-process__stage--panel-open"
              ...
              <div id="process-panel-readiness"
                ...
                <ul class="uk-list uk-list-bullet calhelp-process__list">
            ...
            <article id="process-step-mapping"
              ...
              <button type="button"
                ...
                <span class="calhelp-process__toggle-label"
                      data-page-i18n
                      data-i18n-de="Leistungen &amp; Abnahme anzeigen"
                      data-i18n-en="Show deliverables &amp; acceptance"
                      data-page-toggle-label-de-expanded="Leistungen &amp; Abnahme ausblenden"
                      data-page-toggle-label-de-collapsed="Leistungen &amp; Abnahme anzeigen"
                      data-page-toggle-label-en-expanded="Hide deliverables &amp; acceptance"
                      data-page-toggle-label-en-collapsed="Show deliverables &amp; acceptance">Leistungen &amp; Abnahme anzeigen</span>
                <span class="calhelp-process__toggle-icon" aria-hidden="true"></span>
              </button>
...
<section id="results"
         class="uk-section uk-section-muted calhelp-section"
...
<section id="proof" class="uk-section calhelp-section" data-page-theme="default" aria-labelledby="proof-title">
  <div class="uk-container">
    <div class="calhelp-section__header">
      <h2 id="proof-title" class="uk-heading-medium">Was Vertrauen schafft</h2>
      <p class="uk-text-lead">Nachweise, die Audits bestehen – vom Erstgespräch bis zum Report.</p>
    </div>
    <div class="calserver-stats-strip calhelp-proof-strip" role="list">
      <article class="calserver-stats-strip__item calhelp-proof-card" role="listitem" aria-labelledby="proof-evidence-title">
        <p class="calhelp-proof-card__eyebrow">Audit-Trail</p>
        <h3 id="proof-evidence-title" class="calhelp-proof-card__headline">Belegbar.</h3>
        <p class="calhelp-proof-card__subhead">Checklisten &amp; Signaturen automatisch.</p>
        <p class="calhelp-proof-card__body">Checklisten, Feld-Mappings und Signaturen landen automatisch im Audit-Trail.</p>
      </article>
      <article class="calserver-stats-strip__item calhelp-proof-card" role="listitem" aria-labelledby="proof-quality-title">
        <p class="calhelp-proof-card__eyebrow">Validierung</p>
        <h3 id="proof-quality-title" class="calhelp-proof-card__headline">Qualitätsgeprüft.</h3>
        <p class="calhelp-proof-card__subhead">JRXML, Golden Samples, Reports.</p>
        <p class="calhelp-proof-card__body">JRXML-Vorlagen, Golden Samples und Validierungsreports sind jederzeit abrufbar.</p>
      </article>
      <article class="calserver-stats-strip__item calhelp-proof-card" role="listitem" aria-labelledby="proof-security-title">
        <p class="calhelp-proof-card__eyebrow">Betrieb</p>
        <h3 id="proof-security-title" class="calhelp-proof-card__headline">Sicher.</h3>
        <p class="calhelp-proof-card__subhead">Deutschland &amp; On-Premises.</p>
        <p class="calhelp-proof-card__body">Hosting in Deutschland oder On-Prem – rollenbasiert, verschlüsselt, nachvollziehbar.</p>
      </article>
    </div>
    <div class="uk-margin-large-top">
...
<section id="knowledge" class="uk-section calhelp-section" data-page-theme="default" aria-labelledby="knowledge-title">
  <div class="uk-container">
    <div class="calhelp-section__header">
...
<section id="conversation" class="uk-section calhelp-section" data-page-theme="default" aria-labelledby="conversation-title">
  <div class="uk-container">
    <div class="calhelp-section__header">
    ...
    <div class="uk-grid-large" data-uk-grid>
      <div class="uk-width-1-2@m">
        <ol class="calhelp-demo-steps uk-card uk-card-primary uk-card-body" aria-label="Ablauf des Erstgesprächs">
          ...
          <li>Lage kurz klären: Datenstand, Prioritäten und Zeitfenster werden gemeinsam sortiert.</li>
...
<section id="news" class="uk-section calhelp-section" data-page-theme="default" aria-labelledby="news-title">
  <div class="uk-container">
    <div class="calhelp-section__header">
    ...
    <aside class="calhelp-newsletter uk-card uk-card-primary uk-card-body uk-light" aria-label="Newsletter-Box">
      ...
      <a class="uk-button uk-button-default" href="{{ basePath }}/calserver#contact-us">Gespräch starten</a>
    </aside>
...
<section id="faq"
  ...
  <div class="uk-container">
    ...
    <div class="calhelp-faq__footer">
      ...
      <a class="calhelp-faq__footer-link" href="{{ basePath }}/calserver#contact-us">Weitere Fragen → Gespräch starten</a>
    </div>
  </div>
</section>

<section id="cta"
         class="uk-section calhelp-section calhelp-cta"
      ...
      <div>
        <form id="contact-form"
          ...
          <div class="uk-margin">
            ...
            <input class="uk-input" id="form-name" name="name" type="text" autocomplete="name" required>
          </div>
          <div class="uk-margin">
            <label class="uk-form-label" for="form-email">E-Mail</label>
            <input class="uk-input" id="form-email" name="email" type="email" autocomplete="email" required>
          </div>
          <div class="uk-margin">
            <label class="uk-form-label" for="form-company">Unternehmen (optional)</label>
            <input class="uk-input" id="form-company" name="company_name" type="text" autocomplete="organization">
          </div>
          <div class="uk-margin">
            <label class="uk-form-label" for="form-msg">Wobei sollen wir helfen?</label>
            <textarea class="uk-textarea" id="form-msg" name="message" rows="4" maxlength="160" required></textarea>
          </div>
          ...
          <div class="uk-margin">
            <label>
              ...
              Wir nutzen Ihre Angaben ausschließlich zur Rückmeldung. Details:
          ...
          <button class="btn btn-black uk-button uk-button-secondary uk-button-large uk-width-1-1" type="submit">Gespräch starten</button>
        </form>
      </div>
      <div>
        <div class="uk-card uk-card-default uk-card-body uk-text-left calhelp-cta__panel">
          ...
          <div class="calhelp-cta__actions uk-margin-medium-top" role="group" aria-label="Abschluss-CTAs">
            <a class="uk-button uk-button-primary uk-width-1-1" href="{{ basePath }}/calserver#contact-us">Gespräch starten</a>
            <a class="uk-button uk-button-default uk-width-1-1" href="#approach">Lage kurz klären</a>
          </div>
        </div>
          ...
          <div class="calserver-metcal__grid" role="list">
            ...
            <article class="calserver-metcal__card calserver-metcal__card--outline" role="listitem">
              ...
              <ul>
                ...
                <li>Endlich korrekte Anzeigen der erweiterten Messunsicherheit durch intelligente Feldformeln in der Software</li>
              </ul>
            </article>
          </div>
            ...
            <ul id="calserver-modules-switcher" class="uk-switcher calserver-modules-switcher">
                  ...
                  <figure id="module-device-management" class="calserver-module-figure">
                    <video class="calserver-module-figure__video"
                           ...
                           data-src="{{ basePath }}/uploads/calserver-module-device-management.mp4"
                           data-poster="{{ basePath }}/uploads/calserver-module-device-management.webp"
                           aria-label="Screenshot der calServer-Geräteverwaltung mit Geräteakte, Historie und Messwerten">
                      <source data-src="{{ basePath }}/uploads/calserver-module-device-management.mp4" type="video/mp4">
                  ...
                  <figure id="module-calendar-resources" class="calserver-module-figure">
                    <video class="calserver-module-figure__video"
                           ...
                           data-src="{{ basePath }}/uploads/calserver-module-calendar-resources.mp4"
                           data-poster="{{ basePath }}/uploads/calserver-module-calendar-resources.webp"
                           aria-label="Screenshot des calServer-Kalenders mit Ressourcen- und Terminplanung">
                      <source data-src="{{ basePath }}/uploads/calserver-module-calendar-resources.mp4" type="video/mp4">
                      Ihr Browser unterstützt keine HTML5-Videos.
                  ...
                  <figure id="module-order-ticketing" class="calserver-module-figure">
                    <video class="calserver-module-figure__video"
                           ...
                           data-src="{{ basePath }}/uploads/calserver-module-order-ticketing.mp4"
                           data-poster="{{ basePath }}/uploads/calserver-module-order-ticketing.webp"
                           aria-label="Screenshot der calServer-Auftrags- und Ticketverwaltung mit Workflow-Status">
                      <source data-src="{{ basePath }}/uploads/calserver-module-order-ticketing.mp4" type="video/mp4">
                      Ihr Browser unterstützt keine HTML5-Videos.
                  ...
                  <figure id="module-self-service" class="calserver-module-figure">
                    <video class="calserver-module-figure__video"
                           ...
                           data-src="{{ basePath }}/uploads/calserver-module-self-service.mp4"
                           data-poster="{{ basePath }}/uploads/calserver-module-self-service.webp"
                           aria-label="Screenshot des calServer-Self-Service-Portals mit Kundenansicht und Zertifikaten">
                      <source data-src="{{ basePath }}/uploads/calserver-module-self-service.mp4" type="video/mp4">
                      Ihr Browser unterstützt keine HTML5-Videos.
