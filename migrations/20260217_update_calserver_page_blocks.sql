-- Replace calServer page content with proper CMS block JSON
-- Maps the one-pager design to standard block types:
--   hero, stat_strip, feature_list, testimonial, package_summary, rich_text, cta
UPDATE pages
SET content = $CONTENT${
  "id": "calserver",
  "locale": "de",
