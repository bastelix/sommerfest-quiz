...
VALUES (
  ...
  <div class="uk-container uk-container-small legal-container">
    ...
    <h2 class="uk-heading-bullet">Proprietäre Lizenz (Deutsch)</h2>
<pre class="uk-text-small">
Proprietäre Lizenz - Sommerfest Quiz

Copyright (c) 2025 René Buske
Alle Rechte vorbehalten.

Die Nutzung der Software "Sommerfest Quiz" ist für kommerzielle Zwecke erlaubt.
Der Quellcode bleibt Eigentum von René Buske und darf ohne vorherige schriftliche Zustimmung weder kopiert noch verbreitet, verändert oder öffentlich zugänglich gemacht werden.
...
The source code remains the property of René Buske and may not be copied, distributed, modified or made publicly accessible without prior written permission.
