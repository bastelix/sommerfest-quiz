...
VALUES (
    ...
    $LANDING$
<!-- Social Proof -->
<section id="social-proof" class="uk-section" data-inline-editable="true">
...
<!-- Live-Dashboard -->
<section id="live-dashboard" class="uk-section section section--plain live-dashboard" data-inline-editable="true">
  <div class="uk-container container-xl">
    <div class="uk-grid-large uk-child-width-1-2@m uk-flex-middle" uk-grid>
      <div class="live-dashboard__content">
        ...
        <h2 class="uk-heading-medium uk-margin-small-top">Live-Dashboard im Überblick</h2>
      ...
      <div>
        <div class="uk-card uk-card-quizrace uk-card-body live-dashboard__card" aria-label="Vorschau auf das Live-Dashboard">
          <figure class="live-dashboard__preview" role="img" aria-label="Platzhalter für einen Screenshot des Live-Dashboards">
            <div class="live-dashboard__preview-inner">
              <span class="live-dashboard__preview-title">Live-Dashboard</span>
              <span class="live-dashboard__preview-text">Bildvorschau folgt in Kürze</span>
            </div>
          </figure>
        </div>
      </div>
...
<!-- So funktioniert's -->
<section id="how-it-works" class="uk-section section section--alt" data-inline-editable="true">
  <div class="uk-container container-xl">
...
<section id="scenarios" class="uk-section section section--plain" data-inline-editable="true">
  <div class="uk-container container-xl">
...
<!-- Editor -->
<section id="editor" class="uk-section section section--alt" data-inline-editable="true">
  <div class="uk-container container-xl">
    <div class="uk-grid-large uk-flex-middle uk-child-width-1-2@m" uk-grid>
      <div>
        <h2 class="uk-heading-medium">Editor im Überblick</h2>
        <p class="uk-text-lead uk-margin-small-top">Alles live im Blick – ohne Regie-Stress</p>
...
<!-- Pricing / Abomodelle -->
<section id="pricing" class="uk-section" data-inline-editable="true">
    <div class="uk-container">
...
<!-- FAQ -->
<section id="faq" class="uk-section section--alt" data-inline-editable="true">
...
<!-- Kontakt -->
<section id="contact-us" class="uk-section" data-inline-editable="true">
  <div class="uk-container">
