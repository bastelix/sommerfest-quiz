...
import { Extension as Extension4 } from "./core.esm.js";

// node_modules/@tiptap/starter-kit/node_modules/@tiptap/extension-blockquote/dist/index.js
import { Node, mergeAttributes, wrappingInputRule } from "./core.esm.js";
var inputRegex = /^\s*>\s$/;
...
import { Mark, mergeAttributes as mergeAttributes2, markInputRule, markPasteRule } from "./core.esm.js";
...
// node_modules/@tiptap/starter-kit/node_modules/@tiptap/extension-bullet-list/dist/index.js
import { Node as Node2, mergeAttributes as mergeAttributes3, wrappingInputRule as wrappingInputRule2 } from "./core.esm.js";
...
var BulletList = Node2.create({
  ...
  renderHTML({ HTMLAttributes }) {
    return ["ul", mergeAttributes3(this.options.HTMLAttributes, HTMLAttributes), 0];
  },
  addCommands() {
    return {
...
import { Mark as Mark2, mergeAttributes as mergeAttributes4, markInputRule as markInputRule2, markPasteRule as markPasteRule2 } from "./core.esm.js";
var inputRegex3 = /(^|[^`])`([^`]+)`(?!`)/;
var pasteRegex = /(^|[^`])`([^`]+)`(?!`)/g;
var Code = Mark2.create({
  ...
  renderHTML({ HTMLAttributes }) {
    return ["code", mergeAttributes4(this.options.HTMLAttributes, HTMLAttributes), 0];
  },
  addCommands() {
    return {
      setCode: () => ({ commands }) => {
...
// node_modules/@tiptap/starter-kit/node_modules/@tiptap/extension-code-block/dist/index.js
import { Node as Node4, mergeAttributes as mergeAttributes5, textblockTypeInputRule } from "./core.esm.js";
...
var Node3 = class _Node {
  ...
  */
  hasMarkup(type, attrs, marks) {
    return this.type == type && compareDeep(this.attrs, attrs || type.defaultAttrs || emptyAttrs) && Mark3.sameSet(this.marks, marks || Mark3.none);
  }
  /**
...
var DOMParser = class _DOMParser {
  ...
  */
  parse(dom, options = {}) {
    ...
    context.addAll(dom, Mark3.none, options.from, options.to);
...
var ParseContext = class {
  constructor(parser, options, isOpen) {
    ...
    if (topNode)
      topContext = new NodeContext(topNode.type, topNode.attrs, Mark3.none, true, options.topMatch || topNode.type.contentMatch, topOptions);
    else if (isOpen)
      topContext = new NodeContext(null, null, Mark3.none, true, null, topOptions);
    else
      topContext = new NodeContext(parser.schema.topNodeType, null, Mark3.none, true, null, topOptions);
...
import { Node as Node5 } from "./core.esm.js";
var Document = Node5.create({
  name: "doc",
  topNode: true,
  content: "block+"
});

// node_modules/@tiptap/starter-kit/node_modules/@tiptap/extension-dropcursor/dist/index.js
import { Extension } from "./core.esm.js";
...
// node_modules/@tiptap/starter-kit/node_modules/@tiptap/extension-gapcursor/dist/index.js
import { Extension as Extension2, callOrReturn, getExtensionField } from "./core.esm.js";
  ...
  updateChildren(view, pos) {
    ...
    iterDeco(this.node, this.innerDeco, (widget, i, insideNode) => {
      if (widget.spec.marks)
        ...
        updater.syncToMarks(i == this.node.childCount ? Mark3.none : this.node.child(i).marks, inline, view);
...
// node_modules/@tiptap/starter-kit/node_modules/@tiptap/extension-hard-break/dist/index.js
import { Node as Node6, mergeAttributes as mergeAttributes6 } from "./core.esm.js";
var HardBreak = Node6.create({
  ...
  renderHTML({ HTMLAttributes }) {
    return ["br", mergeAttributes6(this.options.HTMLAttributes, HTMLAttributes)];
  },
  renderText() {
    return "\n";
  },
...
import { Node as Node7, mergeAttributes as mergeAttributes7, textblockTypeInputRule as textblockTypeInputRule2 } from "./core.esm.js";
var Heading = Node7.create({
  ...
  renderHTML({ node, HTMLAttributes }) {
    ...
    return [`h${level}`, mergeAttributes7(this.options.HTMLAttributes, HTMLAttributes), 0];
  },
  addCommands() {
    return {
  ...
  addInputRules() {
    return this.options.levels.map((level) => {
      return textblockTypeInputRule2({
...
// node_modules/@tiptap/starter-kit/node_modules/@tiptap/extension-history/dist/index.js
import { Extension as Extension3 } from "./core.esm.js";
...
import { Node as Node8, mergeAttributes as mergeAttributes8, canInsertNode, isNodeSelection, nodeInputRule } from "./core.esm.js";
var HorizontalRule = Node8.create({
  ...
  renderHTML({ HTMLAttributes }) {
    return ["hr", mergeAttributes8(this.options.HTMLAttributes, HTMLAttributes)];
  },
  addCommands() {
    return {
...
import { Mark as Mark4, mergeAttributes as mergeAttributes9, markInputRule as markInputRule3, markPasteRule as markPasteRule3 } from "./core.esm.js";
var starInputRegex2 = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))$/;
var starPasteRegex2 = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))/g;
var underscoreInputRegex2 = /(?:^|\s)(_(?!\s+_)((?:[^_]+))_(?!\s+_))$/;
var underscorePasteRegex2 = /(?:^|\s)(_(?!\s+_)((?:[^_]+))_(?!\s+_))/g;
var Italic = Mark4.create({
  name: "italic",
  addOptions() {
    return {
      HTMLAttributes: {}
  ...
  renderHTML({ HTMLAttributes }) {
    return ["em", mergeAttributes9(this.options.HTMLAttributes, HTMLAttributes), 0];
  },
  addCommands() {
    return {
      setItalic: () => ({ commands }) => {
...
// node_modules/@tiptap/starter-kit/node_modules/@tiptap/extension-list-item/dist/index.js
import { Node as Node9, mergeAttributes as mergeAttributes10 } from "./core.esm.js";
...
// node_modules/@tiptap/starter-kit/node_modules/@tiptap/extension-ordered-list/dist/index.js
import { Node as Node10, mergeAttributes as mergeAttributes11, wrappingInputRule as wrappingInputRule3 } from "./core.esm.js";
var ListItemName2 = "listItem";
var TextStyleName2 = "textStyle";
var inputRegex4 = /^(\d+)\.\s$/;
var OrderedList = Node10.create({
  name: "orderedList",
  addOptions() {
    return {
      itemTypeName: "listItem",
  ...
  renderHTML({ HTMLAttributes }) {
    ...
    return start === 1 ? ["ol", mergeAttributes11(this.options.HTMLAttributes, attributesWithoutStart), 0] : ["ol", mergeAttributes11(this.options.HTMLAttributes, HTMLAttributes), 0];
  },
  addCommands() {
    return {
...
import { Node as Node11, mergeAttributes as mergeAttributes12 } from "./core.esm.js";
var Paragraph = Node11.create({
  name: "paragraph",
  priority: 1e3,
  addOptions() {
    return {
  ...
  renderHTML({ HTMLAttributes }) {
    return ["p", mergeAttributes12(this.options.HTMLAttributes, HTMLAttributes), 0];
  },
  addCommands() {
    return {
...
// node_modules/@tiptap/starter-kit/node_modules/@tiptap/extension-strike/dist/index.js
import { Mark as Mark5, mergeAttributes as mergeAttributes13, markInputRule as markInputRule4, markPasteRule as markPasteRule4 } from "./core.esm.js";
var inputRegex5 = /(?:^|\s)(~~(?!\s+~~)((?:[^~]+))~~(?!\s+~~))$/;
var pasteRegex2 = /(?:^|\s)(~~(?!\s+~~)((?:[^~]+))~~(?!\s+~~))/g;
var Strike = Mark5.create({
  name: "strike",
  addOptions() {
    return {
      HTMLAttributes: {}
  ...
  renderHTML({ HTMLAttributes }) {
    return ["s", mergeAttributes13(this.options.HTMLAttributes, HTMLAttributes), 0];
  },
  addCommands() {
    return {
      setStrike: () => ({ commands }) => {
...
import { Node as Node12 } from "./core.esm.js";
var Text = Node12.create({
  name: "text",
  group: "inline"
});

// node_modules/@tiptap/starter-kit/dist/index.js
var StarterKit = Extension4.create({
  name: "starterKit",
  addExtensions() {
