...
// Extracted from admin.js into a dedicated module.

export function initConfig(ctx) {
  const {
    apiFetch,
    notify,
    withBase,
  ...
  // --- Helpers moved here from admin.js (they reference config-section variables) ---
  ...
  return {
    ...
    get catalogApi() { return catalogApi; },
    set catalogApi(v) { catalogApi = v; },
    queueCfgSave,
    saveCfg,
  };
}
